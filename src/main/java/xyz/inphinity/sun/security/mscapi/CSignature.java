...
import xyz.inphinity.sun.security.rsa.RSAKeyFactory;
import xyz.inphinity.sun.security.util.ECUtil;
import xyz.inphinity.sun.security.util.KeyUtil;
    ...
    static class RSA extends CSignature {
        ...
        protected byte[] engineSign() throws SignatureException {
            ...
            return signCngHash(1, hash, hash.length,
                    0,
                    this instanceof CSignature.NONEwithRSA ? null : messageDigestAlgorithm,
...
//                boolean noHashOID = this instanceof CSignature.NONEwithRSA;
