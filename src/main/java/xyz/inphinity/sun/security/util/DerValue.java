...
package xyz.inphinity.sun.security.util;

import xyz.inphinity.sun.security.util.DerIndefLenConverter;
import xyz.inphinity.sun.security.util.IOUtils;
import xyz.inphinity.sun.security.util.ObjectIdentifier;
...
public class DerValue {
    ...
    public String getUniversalString() throws IOException {
        return readStringInternal(tag_UniversalString, Charset.forName("UTF-32BE"));
    }
    ...
    private Date getTimeInternal(boolean generalized) throws IOException {
         ...
         */
        ZonedDateTime ldt = ZonedDateTime.of(year, month, day, hour, minute, second, millis * 1_000_000, ZoneId.of("UTC"));
        long time = Instant.from(ldt).toEpochMilli();
