...
#include <stdio.h>
#include <memory>
#include "xyz_inphinity_sun_security_mscapi_CKey.h"
#include "xyz_inphinity_sun_security_mscapi_CKeyStore.h"
#include "xyz_inphinity_sun_security_mscapi_PRNG.h"
#include "xyz_inphinity_sun_security_mscapi_CRSACipher.h"
#include "xyz_inphinity_sun_security_mscapi_CKeyPairGenerator_RSA.h"
#include "xyz_inphinity_sun_security_mscapi_CPublicKey.h"
#include "xyz_inphinity_sun_security_mscapi_CPublicKey_CRSAPublicKey.h"
#include "xyz_inphinity_sun_security_mscapi_CSignature.h"
#include "xyz_inphinity_sun_security_mscapi_CSignature_RSA.h"
...
#define EXPORT_BLOB(p) \
    ...
    JNIEXPORT void JNICALL Java_xyz_inphinity_sun_security_mscapi_CKeyStore_removeCngKey
     ...
     * Signature: ([BIJZ)[B
     */
    JNIEXPORT jbyteArray JNICALL Java_xyz_inphinity_sun_security_mscapi_CRSACipher_cngEncryptDecrypt
    (JNIEnv* env, jclass clazz, jbyteArray jData, jint jDataSize, jlong hKey,
        jboolean doEncrypt)
    {
        SECURITY_STATUS ss;
